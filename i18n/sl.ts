...
export const sl = {
  ...
  finance: {
    ...
    details: 'Podrobnosti',
    tab: 'Finance',
    totalCosts: 'Skupni stroški',
    paid: 'Plačano',
    unpaid: 'Neplačano',
    debtors: 'Dolžniki',
    debtorCount: (n: number) => `${n} dolžnik${n === 1 ? '' : 'ov'}`,
    noDebtors: 'Ni odprtih dolgov.',
    fundingMode: 'Način financiranja',
    perEvent: 'Plačilo na dogodek',
    monthly: 'Mesečni prispevek',
    annual: 'Letni prispevek',
    amount: 'Znesek (€)',
    saveSettings: 'Shrani nastavitve',
    settingsSaved: 'Nastavitve financiranja shranjene.',
    settleEvent: 'Poravnaj ta dogodek',
    settleHint: 'Strošek dogodka enakomerno razdeli med trenutne udeležence.',
    settled: 'Dogodek poravnan.',
    generateMonth: 'Ustvari ta mesec',
    generateYear: 'Ustvari to leto',
    generated: 'Obveznosti ustvarjene.',
    alreadyGenerated: 'To obdobje je že ustvarjeno.',
    manualExpense: 'Ročni prispevek',
    expenseTitle: 'Naziv stroška',
    expenseAmount: 'Znesek (€)',
    splitEqualAll: 'Enakomerno med vse člane',
    splitAttendees: 'Samo med prisotne',
    splitSelected: 'Izbrani člani',
    createExpense: 'Ustvari strošek',
    expenseCreated: 'Strošek ustvarjen.',
    statusPaid: 'Plačano',
    statusPartial: 'Delno plačano',
    statusUnpaid: 'Neplačano',
    statusWaived: 'Oproščeno',
    recordPayment: 'Zabeleži plačilo',
    markPaid: 'Označi plačano',
    waive: 'Oprosti',
    open: 'Odprto',
    total: 'Skupaj',
    myPayments: 'Moja plačila',
    paidThisYear: 'Plačano letos',
    openObligations: 'Odprte obveznosti',
    nextDue: 'Naslednja zapadlost',
    noObligations: 'Še ni obveznosti.',
    runSql: 'Najprej v Supabase zaženi supabase/activity_finance.sql.',
    needMembers: 'Potreben je vsaj en član.',
    needAmount: 'Vnesi veljaven znesek.',
    needTitle: 'Vnesi naziv.',
    onlyRecurring: 'Finance so na voljo za ponavljajoče aktivnosti.',
    together: 'Skupaj',
  },
  common: {
    cancel: 'Prekliči',
