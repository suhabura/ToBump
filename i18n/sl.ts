...
export const sl = {
  ...
  form: {
    ...
    pricePerEventHint: 'Vsak plačnik dolguje to organizatorju; znesek gre v budget dogodka.',
    priceMonthlyHint: 'Vsak plačnik dolguje to mesečno; gre v budget (1× na mesec).',
    priceFixedHint: 'Vsak plačnik dolguje to enkrat; gre v budget (1× za serijo).',
    whoPays: 'Kdo plača?',
    whoPaysInvitees: 'Povabljenci',
    whoPaysAttendees: 'Udeleženci',
    whoPaysHint: 'Vsaka izbrana oseba dolguje znesek na osebo v budget dogodka.',
  },
  finance: {
    title: 'Finance',
    details: 'Podrobnosti',
    ...
    runSql:
      'Najprej v Supabase zaženi activity_finance.sql, activity_finance_enabled.sql in activity_finance_budget.sql.',
    ...
    feesToBudget: 'Prispevki udeležencev gredo v budget dogodka',
    fundingSummary: (who: string, n: number) => `${who} · ${n} oseb`,
  },
  guests: {
    title: 'Gosti',
    guest: 'gost',
