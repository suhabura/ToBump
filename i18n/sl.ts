...
export const sl = {
  ...
  finance: {
    ...
    budgetIn: 'Prispevki → budget',
    budgetOut: 'Porabljeno iz budgeta',
    addExpense: 'Dodaj strošek',
    expenseHint: 'Vpiši dejanske stroške (prostor, hrana, vstopnine…). Prispevki udeležencev gredo v Budget.',
    expenseTitle: 'Za kaj?',
    ...
    runSql:
      'Najprej v Supabase zaženi activity_finance.sql, activity_finance_enabled.sql, activity_finance_budget.sql, activity_finance_payers.sql in activity_finance_monthly.sql.',
    ...
    eventTotal: 'Zbrani prispevki',
    perPerson: 'Na udeleženca',
    paysOrganizer: 'Plača se organizatorju',
    feesToBudget: 'Strošek se ustvari, ko se upravičena oseba prvič udeleži',
  ...
  guests: {
    ...
    runSql: 'Najprej v Supabase zaženi supabase/activity_guests.sql.',
  },
  common: {
    cancel: 'Prekliči',
    confirm: 'Potrdi',
