...
export const sl = {
  ...
  form: {
    ...
    pricePerEventHint: 'Vsak plačnik dolguje to organizatorju za ta termin (gre v Expenses).',
    priceMonthlyHint: 'Vsak plačnik dolguje to mesečno organizatorju (1× na mesec v Expenses).',
    priceFixedHint: 'Vsak plačnik dolguje to enkrat organizatorju (1× v Expenses za serijo).',
    whoPays: 'Kdo plača?',
    whoPaysInvitees: 'Povabljenci',
    whoPaysAttendees: 'Udeleženci',
    whoPaysHint: 'Vsaka izbrana oseba dolguje znesek na osebo organizatorju.',
  },
  finance: {
    title: 'Finance',
    details: 'Podrobnosti',
