...
export const sl = {
  ...
  form: {
    ...
    pricePerEvent: 'Cena na dogodek (€)',
    priceMonthly: 'Mesečni znesek (€)',
    priceFixed: 'Določen znesek (€)',
    pricePerEventHint: 'Ta cena velja za vsak termin v Finance.',
    priceMonthlyHint: 'Mesečni prispevek za serijo.',
    priceFixedHint: 'Enkratni določen znesek za celotno serijo.',
  },
  finance: {
    title: 'Finance',
    details: 'Podrobnosti',
