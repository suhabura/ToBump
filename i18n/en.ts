...
export const en = {
  ...
  finance: {
    ...
    runSql:
      'Run supabase/activity_finance.sql (+ enabled, budget, payers, monthly, paid_budget, member_settings) in Supabase first.',
    ...
    feesToBudget: 'Fees appear after eligible people attend; tick when paid so they enter the budget.',
  ...
  guests: {
    ...
    runSql: 'Run supabase/activity_guests.sql and activity_finance_paid_budget.sql in Supabase first.',
  },
  common: {
    cancel: 'Cancel',
    confirm: 'Confirm',
