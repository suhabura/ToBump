...
export const en = {
  ...
  finance: {
    ...
    runSql:
      'Run supabase/activity_finance.sql, activity_finance_enabled.sql, activity_finance_budget.sql, activity_finance_payers.sql and activity_finance_monthly.sql in Supabase first.',
    ...
    eventTotal: 'Fees collected',
    perPerson: 'Per person',
    paysOrganizer: 'Paid to the organizer',
    feesToBudget: 'Fees are created when an eligible person attends for the first time',
