...
export const en = {
  ...
  form: {
    ...
    priceMonthly: 'Monthly amount (€)',
    priceFixed: 'Fixed amount (€)',
    pricePerEventHint: 'Each occurrence uses this price in Finance.',
    priceMonthlyHint: 'Monthly contribution for the series.',
    priceFixedHint: 'One fixed amount for the whole series.',
  },
  finance: {
    title: 'Finance',
    details: 'Details',
