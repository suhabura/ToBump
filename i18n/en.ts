...
export const en = {
  ...
  finance: {
    ...
    unpaid: 'Unpaid',
    debtors: 'Debtors',
    debtorCount: (n: number) => `${n} debtor${n === 1 ? '' : 's'}`,
    noDebtors: 'No open debts.',
    fundingMode: 'Funding mode',
    perEvent: 'Pay per event',
    monthly: 'Monthly contribution',
    annual: 'Annual contribution',
    amount: 'Amount (€)',
    saveSettings: 'Save funding settings',
    settingsSaved: 'Funding settings saved.',
    settleEvent: 'Settle this event',
    settleHint: 'Splits the event cost equally among current attendees.',
    settled: 'Event settled.',
    generateMonth: 'Generate this month',
    generateYear: 'Generate this year',
    generated: 'Obligations created.',
    alreadyGenerated: 'This period was already generated.',
    manualExpense: 'Manual expense',
    expenseTitle: 'Expense title',
    expenseAmount: 'Amount (€)',
    splitEqualAll: 'Split equally among all members',
    splitAttendees: 'Split among attendees',
    splitSelected: 'Split among selected members',
    ...
    needMembers: 'Need at least one member.',
    needAmount: 'Enter a valid amount.',
    needTitle: 'Enter a title.',
    onlyRecurring: 'Finance is available for recurring activities.',
    together: 'Total',
  },
  common: {
    cancel: 'Cancel',
