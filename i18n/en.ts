...
export const en = {
  ...
  events: {
    ...
    inviteNotice: (name: string, title: string) => `${name} invited you to ${title}.`,
    joinedNotice: (name: string, title: string, count: number) =>
      `${name} joined ${title}. ${count} people are going now.`,
    ...
    save: 'Save',
    delete: 'Delete',
    deleteThisOnly: 'This date only',
    deleteSeries: 'Entire series',
    deleteRecurringPrompt: 'Delete only this date, or the whole recurring series? A deleted date also leaves the planner.',
  ...
  planner: {
    ...
    followHint: 'Future dates appear on your planner. You still join each date separately.',
  ...
  friends: {
    ...
    newRequest: (name: string) => `${name} sent you a friend request.`,
  ...
  form: {
    ...
    desiredCapacity: 'How many people you need',
    needPeople: 'Enter how many people you need.',
    needMorePeople: (n: number) =>
      `Invite ${n} more. You count as one.`,
