...
export const en = {
  ...
  form: {
    ...
    pricePerEventHint: 'Each payer owes this to the organizer for this occurrence (added to Expenses).',
    priceMonthlyHint: 'Each payer owes this monthly to the organizer (one Expenses entry per month).',
    priceFixedHint: 'Each payer owes this once to the organizer (one Expenses entry for the series).',
    whoPays: 'Who pays?',
    whoPaysInvitees: 'Invitees',
    whoPaysAttendees: 'Attendees',
    whoPaysHint: 'Each selected person owes the per-person amount to the organizer.',
  },
  finance: {
    title: 'Finance',
    details: 'Details',
